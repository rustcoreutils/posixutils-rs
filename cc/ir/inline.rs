...
/// GCC uses 2700; we use a lower value because c17's stack frames grow
...
/// This is a c17-specific workaround: without register promotion for
/// addr-taken locals, c17's stack frames grow linearly with inlined code.
...
fn should_inline(
    ...
    // c17-specific: without register promotion, every inlined copy adds
    ...
    // locals and spills add up in c17's current register allocator).
