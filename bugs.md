...
### Remaining: test_complex, test_functools, test_copy, test_io crash
- Some tests still crash — likely more codegen bugs surfacing in specific code patterns
- test_int, test_grammar, test_syntax, test_exceptions fail due to `_testcapi` module (disabled in build)
