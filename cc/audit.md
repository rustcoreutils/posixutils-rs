...
- [ ] `_Generic` and `CMPLX` — still uncovered. _(Unicode literal prefixes are covered by `cc/tests/c11/literals.rs`; incompatible typedef redefinition by `diagnostics_incompatible_typedef_redefinition_is_rejected`.)_
