...
- [x] `set_ti_flag`/`speed_to_str`/`build_flagstr`/`cchar_to_str` pure-function unit tests (no TTY needed) — `stty.rs` `mod tests`.
- [x] `stty 50` selects `B50` (#6) — `test_speed_table_50_not_54` + `test_stty_speed_50`.
